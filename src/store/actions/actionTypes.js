const actionTypes = Object.freeze({
    ...
    // SAVE SPECIALIST
    SAVE_SPECIALIST: 'SAVE_SPECIALIST',
    SAVE_SPECIALIST_FAIL: 'SAVE_SPECIALIST_FAIL',
    SAVE_SPECIALIST_SUCCESS: 'SAVE_SPECIALIST_SUCCESS',

    //  GET ALL SPECIALIST
    GET_ALL_SPECIALIST: 'GET_ALL_SPECIALIST',
    GET_ALL_SPECIALIST_FAIL: 'GET_ALL_SPECIALIST_FAIL',
    GET_ALL_SPECIALIST_SUCCESS: 'GET_ALL_SPECIALIST_SUCCESS',

    // GET_SPECIALIST
    GET_SPECIALIST: 'GET_SPECIALIST',
    GET_SPECIALIST_FAIL: 'GET_SPECIALIST_FAIL',
    GET_SPECIALIST_SUCCESS: 'GET_SPECIALIST_SUCCESS',

    // GET ALL DOCTOR BELONG TO SPECIALIST
    GET_ALL_DOCTOR_BELONG_TO_SPECIALIST: 'GET_ALL_DOCTOR_BELONG_TO_SPECIALIST',
    GET_ALL_DOCTOR_BELONG_TO_SPECIALIST_FAIL: 'GET_ALL_DOCTOR_BELONG_TO_SPECIALIST_FAIL',
    GET_ALL_DOCTOR_BELONG_TO_SPECIALIST_SUCCESS: 'GET_ALL_DOCTOR_BELONG_TO_SPECIALIST_SUCCESS',

    // SAVE CLINIC
    SAVE_CLINIC: 'SAVE_CLINIC',
    ...
    GET_ALL_DOCTOR_BELONG_TO_CLINIC: 'GET_ALL_DOCTOR_BELONG_TO_CLINIC',
    GET_ALL_DOCTOR_BELONG_TO_CLINIC_FAIL: 'GET_ALL_DOCTOR_BELONG_TO_CLINIC_FALI',
    GET_ALL_DOCTOR_BELONG_TO_CLINIC_SUCCESS: 'GET_ALL_DOCTOR_BELONG_TO_CLINIC_SUCCESS',

    //GET_ALL_BOOKING
    GET_ALL_BOOKING: 'GET_ALL_BOOKING',
    GET_ALL_BOOKING_FAIL: 'GET_ALL_BOOKING_FAIL',
    GET_ALL_BOOKING_SUCCESS: 'GET_ALL_BOOKING_SUCCESS',

    //SAVE_BOOKING_STATU
    SAVE_BOOKING_STATU: 'SAVE_BOOKING_STATU',
    SAVE_BOOKING_STATU_FAIL: 'SAVE_BOOKING_STATU_FAIL',
    SAVE_BOOKING_STATU_SUCCESS: 'SAVE_BOOKING_STATU_SUCCESS',
