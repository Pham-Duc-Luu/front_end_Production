...
class SpecialistItem extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.allDoctorSpecialist !== prevProps.allDoctorSpecialist) {
            this.setState({
                allDoctorSpecialist: this.props.allDoctorSpecialist,
            });
        }
    ...
    render() {
        return (
            <>
                <div className=" specialist-page-item p-4 mx-5  shadow p-3 mb-4 bg-white rounded row ">
                    <div className="specialist-doctor col-8">
                    ...
                    <div className="specialist-doctor-schedule col-4">
